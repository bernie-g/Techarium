    ...
    public void renderButton(int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_) {
        ...
        if (!this.tank.getFluid().isEmpty()) {
            ...
            if (flowing != null) {
                ...
                getFluidTexture(flowing).drawPartial(x + tank.getLeftOffset(), y + tank.getTopOffset() + offset, getWidth() - tank.getLeftOffset() - tank.getRightOffset(), getHeight() - tank.getBottomOffset(), 0, stored / capacity, 0, 0);
