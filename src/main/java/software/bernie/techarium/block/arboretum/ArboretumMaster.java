...
public class ArboretumMaster extends MachineBlock<ArboretumTile> {
    ...
    public ArboretumMaster() {
        super(BlockBehaviours.arboretum, Properties.of(Material.METAL).strength(3.5f).harvestLevel(2).harvestTool(ToolType.PICKAXE).noOcclusion().requiresCorrectToolForDrops());
    }
