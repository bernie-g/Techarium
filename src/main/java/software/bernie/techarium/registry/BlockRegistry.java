...
public class BlockRegistry {
    ...
    public static final BlockRegistryObjectGroup<Block, BlockItem, TileEntity> ALUMINIUM_ORE =
            new BlockRegistryObjectGroup<>("aluminium_ore", () -> new Block(Properties.copy(Blocks.IRON_ORE)), blockItemCreator(), null).registerWithoutTile(BLOCKS, ITEMS);
    public static final BlockRegistryObjectGroup<Block, BlockItem, TileEntity> COPPER_ORE =
            new BlockRegistryObjectGroup<>("copper_ore", () -> new Block(Properties.copy(Blocks.IRON_ORE)), blockItemCreator(), null).registerWithoutTile(BLOCKS, ITEMS);
    public static final BlockRegistryObjectGroup<Block, BlockItem, TileEntity> LEAD_ORE =
            new BlockRegistryObjectGroup<>("lead_ore", () -> new Block(Properties.copy(Blocks.IRON_ORE)), blockItemCreator(), null).registerWithoutTile(BLOCKS, ITEMS);
