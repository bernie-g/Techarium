...
import software.bernie.techarium.block.ArboretumBlock;
import software.bernie.techarium.block.BlockRegistryObjectGroup;
import software.bernie.techarium.block.BotariumBlock;
import software.bernie.techarium.block.base.MachineBlock;
import software.bernie.techarium.block.ExchangeStationBlock;
...
public class BlockRegistry {
    ...
    public static final BlockRegistryObjectGroup<BotariumBlock, BlockItem, BotariumTile> BOTARIUM =
            new BlockRegistryObjectGroup<>("botarium", BotariumBlock::new, machineItemCreator(), BotariumTile::new).register(BLOCKS, ITEMS, TILES);
    public static final BlockRegistryObjectGroup<ArboretumBlock, BlockItem, ArboretumTile> ARBORETUM =
            new BlockRegistryObjectGroup<>("arboretum", ArboretumBlock::new, machineItemCreator(), ArboretumTile::new).register(BLOCKS, ITEMS, TILES);
